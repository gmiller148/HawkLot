              ...
              if(isset($_POST['register'])) {
                ...
                if($check_user == 0) {
                  ...
                  if(mysqli_num_rows($run_owned_already) == 0 ){
                    $query = "INSERT INTO owners(email, spotnumber, verified, licenseplate, studentid) VALUES('$email', '$spotnumber', '1', '$licenseplate', '$studentid')";
                    $run_query = mysqli_query($conn, $query);
                    $_POST['owner'] = $email;
                    $_POST['id'] = $spotnumber;
                    include "json_edit.php";
                    $event = "INSERT INTO mastertable(action, user, actiontime, actionrecipient) VALUES('spot_registered', '$email', CURRENT_TIMESTAMP, '$spotnumber')";
